...
# ==================== 配置区 ====================
PROJECT_DIR="/www/wwwroot/admin-test.5super9.com"
DEFAULT_BRANCH="master"  # 默认分支（gk_admin使用master）
# ================================================
...
# 5. 切换并更新分支
echo ""
echo "🔄 [3/4] 正在切换到分支 $BRANCH_NAME 并更新到最新版本..."
