...
return [
    ...
    'titles' => [
        ...
        'store_purchase_score_setting' => '販売機スコア購入設定',
        ...
        //新しいメニュー翻訳（2026-05-13）
        'plugin_manage' => 'プラグイン管理',
        'game_list' => 'ゲームリスト',
        'machine_label' => 'マシンラベル',
        'sms_log' => 'SMSログ',
        'player_report' => 'プレイヤーレポート',
        'national_promoter_manage' => '全国プロモーター管理',
        'user_level_setting' => 'ユーザーレベル設定',
        'invite_reward' => '招待報酬',
        'bank_list' => '銀行リスト',
        'national_promoter_report' => '全国プロモーターレポート',
        'profit_detail' => '利益詳細',
        'reverse_water_manage' => 'リバースウォーター管理',
        'reverse_water_activity' => 'リバースウォーター活動',
        'reverse_water_reward_record' => 'リバースウォーター報酬記録',
        'tencent_cloud_config' => 'Tencent Cloud設定',
        'profit_report' => '利益レポート',
        'admin_operation' => '管理者操作',
        'coin_withdraw_record' => 'コイン出金記録',
        'machine_reward_report' => 'マシン報酬レポート',
        'admin_operation_log' => '管理者操作ログ',
        'profit_settlement' => '利益決済',
        'profit_manage' => '利益管理',
        'offline_agent' => 'オフライン代理店',
        'offline_agent_manage' => 'オフライン代理店管理',
        'offline_agent_list' => 'オフライン代理店リスト',
        'settlement_record' => '決済記録',
        'game_lottery' => 'ゲーム宝くじ',
        'game_player' => 'ゲームプレイヤー',
        'agent_manage' => '代理店バックエンド',
