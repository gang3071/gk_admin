...
return [
    ...
    'coin_recharge' => 'コインディーラー開分',
    'coin_recharge_money' => '開分金額',
    'coin_recharge_point' => '開分ポイント',
    'coin_recharge_title' => '{uuid} を開分しています。支払い金額とポイントを開分してください',
    'coin_recharge_error' => 'コインディーラーの開分に失敗しました',
    'coin_recharge_success' => 'コインディーラーの開分が成功しました',
    'artificial_recharge_error' => '手動開分に失敗しました',
    'artificial_recharge_success' => '手動開分が成功しました',
    ...
    'crashed' => 'クラッシュ済み',
    'normal' => '正常',
    'wallet_locked_status' => 'ウォレットロック状態',
    'wallet_locked' => 'ロック済み',
    'wallet_unlocked' => '正常',
    'wash_score' => 'ウォッシュスコア',
    ...
    'wash_crashed_tip' => '⚠️ デバイスがクラッシュしています！クラッシュ金額のみ洗分可能、超過分はシステムに没収され、ウォレットはクリアされます',
