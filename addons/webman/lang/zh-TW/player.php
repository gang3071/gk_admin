...
return [
    ...
    'coin_recharge_point' => '開分點數',
    'coin_recharge_title' => '您正在給{uuid}開分,請輸入收款金額和開分點數',
    'coin_recharge_error' => '幣商開分失敗',
    'coin_recharge_success' => '幣商開分成功',
    'artificial_recharge_error' => '人工開分失敗',
    'artificial_recharge_success' => '人工開分成功',
    ...
    'action_success' => '操作成功',
    'phone_exist' => '手機號已注册',
    'player_recharge_record' => '開分記錄',
    'player_withdraw_record' => '洗分記錄',
    ...
    'wallet' => [
        ...
        'wallet_type' => [
            ...
            PlayerMoneyEditLog::COIN_RECHARGE => '币商開分',
    ...
    'self_recharge_total' => '平臺開分',
    'artificial_recharge_total' => '人工開分',
    'channel_withdrawal_total' => '平臺洗分',
    'artificial_withdrawal_total' => '人工洗分',
    'total_amount' => '開分/洗分統計',
    'recharge_total' => '總開分點數',
    'withdrawal_total' => '總洗分點數',
    ...
    'total_lottery_ticket_reward_amount' => '摸獎券',
    'subtotal' => '小計',
    'wash_point_config' => '洗分配置',
    'current_shift_stats' => '當前班次統計',
    'current_shift_help' => '當前未交班數據（從上次交班時間至今）',
    'stats_time_range' => '統計時間範圍',
    ...
    'unnamed' => '未命名',
    'game_id_label' => '遊戲 ID: ',
    'device_list_query_log' => '玩家列表查詢',
    'no_device_data' => '暫無玩家數據',
    ...
    'wash_crashed_tip' => '⚠️ 設備已爆機！只能洗分爆機金額，超出部分將被系統沒收，錢包將清零',
