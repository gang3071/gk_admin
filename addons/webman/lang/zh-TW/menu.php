...
//日誌中心
        ...
        'store_purchase_score_setting' => '儲值機購分配置',
        ...
        'sms_log' => '短信日誌',
        'player_report' => '玩家報表',
        'national_promoter_manage' => '全民代理管理',
        'user_level_setting' => '用戶等級設置',
        'invite_reward' => '邀請人數獎勵',
        'bank_list' => '銀行列表',
        'national_promoter_report' => '全民代理報表',
        'profit_detail' => '分潤明細',
        'reverse_water_manage' => '反水管理',
        'reverse_water_activity' => '反水活動',
        'reverse_water_reward_record' => '反水獎勵記錄',
        'tencent_cloud_config' => '騰訊雲配置',
        'profit_report' => '分潤報表',
        'admin_operation' => '管理員操作',
        'coin_withdraw_record' => '幣商提現記錄',
        'machine_reward_report' => '機台大賞報表',
        'admin_operation_log' => '管理員操作日誌',
        'profit_settlement' => '分潤結算',
        'profit_manage' => '分潤管理',
        'offline_agent' => '線下代理',
        'offline_agent_manage' => '線下代理管理',
        'offline_agent_list' => '線下代理列表',
        'settlement_record' => '結算記錄',
        'game_lottery' => '電子遊戲彩金',
        'game_player' => '遊戲玩家',
        'agent_manage' => '代理後台',
        'store_manage' => '店機後台',
        ...
        //總站線下機台管理
        'offline_machine_manage' => '線下機台管理',
        'offline_machine_list' => '線下機台',
        //店家后台线下机台管理
