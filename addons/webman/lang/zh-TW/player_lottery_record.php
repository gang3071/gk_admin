...
return [
    ...
    'btn' => [
        ...
        'retry_pokemon_ball' => '重新派發',
        'retry_pokemon_ball_confirm' => '確定要重新派發精靈球彩金嗎？系統將重新發送通知給玩家。',
    ],
    ...
    'status' => [
        ...
        PlayerLotteryRecord::STATUS_POKEMON_BALL_FAILED => '派發失敗',
    ],
    'total_data' => [
