...
return [
    ...
    'placeholder' => [
        ...
        'stream_name' => '請輸入流名稱（僅英文、數字、下劃線、橫線）',
        'ticket_no' => '請輸入6位券號',
    ...
    'action' => [
        ...
        'copy_push_server' => '複製服務器',
        'copy_stream_key' => '複製密鑰',
        'expand' => '展開',
        'collapse' => '收起',
        'distribute' => '派獎',
    ...
    'message' => [
        ...
        'cannot_close_activity' => '只能關閉未開始或進行中的活動',
    ...
    'error' => [
        ...
        // 推流相关错误
        'stream_name_required' => '流名稱不能為空',
        'invalid_stream_name_format' => '流名稱格式錯誤，只能包含英文字母、數字、下劃線、中橫線',
        'no_tencent_config' => '未找到騰訊雲直播配置，請先在系統中配置推流參數',
        'incomplete_tencent_config' => '騰訊雲直播配置不完整，缺少推流域名或推流密鑰',
        'generate_push_url_failed' => '生成推流地址失敗',
        // 其他
    ...
    'help' => [
        ...
        'activity_name_hint' => '活動名稱將顯示在玩家端，請簡潔明了',
        'description_hint' => '活動說明支持富文本格式，可添加圖片、表格等內容',
        'start_time_hint' => '玩家可開始打碼獲取摸獎券的時間',
        'end_time_hint' => '活動結束後自動進入待開獎狀態',
        'vip_config_detail' => '玩家在活動期間累計達到指定打碼量後，系統將自動發放對應數量的摸獎券',
        'prize_config_detail' => '可添加最多10個獎項，開獎時將從所有中獎券號中抽取對應數量的獎品發放給玩家',
        'prize_name_hint' => '自定義獎項名稱，最多20字',
        'prize_amount_hint' => '中獎玩家將獲得的現金獎勵',
        'prize_count_hint' => '此獎項的獎品總數量',
    ],
    ...
    'ui' => [
        ...
        'cover_hint' => '建議尺寸：750x400px，支持jpg、png格式，文件大小不超過2MB',
        'cover_preview_alt' => '封面預覽',
        'no_vip_data_desc' => '暫無VIP等級數據',
        'set_live_stream_title' => '設置直播流名稱',
        'live_stream_hint' => '💡 只需填寫流名稱，系統會自動生成騰訊云直播地址',
        'live_stream_label' => '直播流名稱',
        'live_stream_placeholder' => '例如：mojiangjuan',
        'live_stream_name_hint' => '建議使用英文、數字、下劃線，此名稱需與OBS推流配置一致',
        'live_preview_title' => '直播預覽 - {name}',
        'live_url_label' => '直播地址：',
        'copy_url' => '複製地址',
        'open_new_window' => '新窗口打開',
        'rtmp_protocol_warning' => 'RTMP 協議播放提示',
        'no_live_url' => '未獲取到直播地址',
        'generating_live_url' => '正在生成直播地址...',
        'live_url_copied' => '直播地址已複製到剪貼板',
        'stream_name_format_error' => '流名稱只能包含英文、數字和下劃線',
        'stream_name_too_long' => '流名稱不能超過50個字符',
        'activity_no_live_url' => '該活動尚未設置直播流名稱',
        'generate_live_url_failed' => '生成直播地址失敗',
        'edit_live_url' => '編輯直播地址',
        'cancel_enter_win' => '取消，先錄入中獎',
    ],
];
