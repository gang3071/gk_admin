...
return [
    ...
    'btn' => [
        ...
        'retry_pokemon_ball' => '重新派发',
        'retry_pokemon_ball_confirm' => '确定要重新派发精灵球彩金吗？系统将重新发送通知给玩家。',
    ],
    ...
    'status' => [
        ...
        PlayerLotteryRecord::STATUS_POKEMON_BALL_FAILED => '派发失败',
    ],
    'total_data' => [
