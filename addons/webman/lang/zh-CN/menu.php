...
return [
    ...
    'titles' => [
        ...
        'store_purchase_score_setting' => '储值机购分配置',
        ...
        'user_level_setting' => '用户等级设置',
        'invite_reward' => '邀请人数奖励',
        'bank_list' => '银行列表',
        'national_promoter_report' => '全民代理报表',
        'profit_detail' => '分润明细',
        'reverse_water_manage' => '反水管理',
        'reverse_water_activity' => '反水活动',
        'reverse_water_reward_record' => '反水奖励记录',
        'tencent_cloud_config' => '腾讯云配置',
        'profit_report' => '分润报表',
        'admin_operation' => '管理员操作',
        'coin_withdraw_record' => '币商提现记录',
        'machine_reward_report' => '机台大赏报表',
        'admin_operation_log' => '管理员操作日志',
        'profit_settlement' => '分润结算',
        'profit_manage' => '分润管理',
        'offline_agent' => '线下代理',
        'offline_agent_manage' => '线下代理管理',
        'offline_agent_list' => '线下代理列表',
