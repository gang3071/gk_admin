...
return [
    ...
    'lottery_amount' => '彩金',
    'total_profit' => '总利润',
    'lottery_ticket_reward_amount_short' => '摸奖券',
    ...
    'record' => [
        ...
        'ticket_redeem_backend_used_score' => '核销记录后台使用金额',
        'ticket_subtotal' => '小计',
        'birthday_bonus_amount' => 'VIP生日礼金',
        'upgrade_bonus_amount' => 'VIP升级礼金',
        'created_at' => '创建时间',
        'detail_title' => '交班详情',
    ...
    'auto' => [
        ...
        'activity_bonus_amount_detail' => '活动奖励金额',
        'lottery_ticket_reward_amount_detail' => '摸奖券中奖奖励',
    ...
    'ticket_unredeemed_amount' => '洗票未核销',
    ...
    'export' => [
        ...
        'fixed_columns_hint' => '导出功能已改为固定14列导出，无需选择栏目。',
    ],
