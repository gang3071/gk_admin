...
return [
    ...
    'placeholder' => [
        ...
        'stream_name' => 'Enter stream name (letters, numbers, underscores, hyphens only)',
    ...
    'modal' => [
        ...
        'stream_name_prompt' => 'Please enter stream name:',
        'generate_push_url_title' => 'Generate Push URL',
    ...
    'action' => [
        ...
        'generate_push_url' => 'Generate Push URL',
        'copy_push_server' => 'Copy Server',
        'copy_stream_key' => 'Copy Key',
        'expand' => 'Expand',
        'collapse' => 'Collapse',
        'award' => 'Award',
    ...
    'message' => [
        ...
        'cannot_close_activity' => 'Can only close activities that are not started or ongoing',
        ...
        'push_url_generated' => 'Push URL generated successfully',
        'push_url_generated_success' => 'Push URL generated successfully, valid for 3 days',
    ...
    'error' => [
        ...
        // Push stream related errors
        'stream_name_required' => 'Stream name is required',
        'invalid_stream_name_format' => 'Invalid stream name format, only letters, numbers, underscores and hyphens allowed',
        'no_tencent_config' => 'Tencent Cloud live streaming configuration not found, please configure push parameters first',
        'incomplete_tencent_config' => 'Tencent Cloud live streaming configuration incomplete, missing push domain or push key',
        'generate_push_url_failed' => 'Failed to generate push URL',
        // 其他
    ...
    'ui' => [
        ...
        'create_from_history' => 'Create from History',
        'live_streaming' => 'Live',
        'not_live' => 'Not Live',
        'preview_live' => 'Preview Live',
        'start_live' => 'Start Live',
        'end_live' => 'End Live',
        'view_ticket_list' => 'View Ticket List',
        'select_image' => 'Select Image',
        'no_history_activities' => 'No History Activities',
        'select_history_activity' => 'Select History Activity',
        'end_live_confirm_title' => 'End Live',
        'end_live_confirm_content' => 'Confirm to end live streaming? Players will not be able to continue watching after ending.',
        'ending_live' => 'Ending live...',
        'start_live_failed' => 'Start live failed',
        'end_live_failed' => 'End live failed',
        'ticket_list_title' => 'Lottery Ticket List',
        'search' => 'Search',
        'reset' => 'Reset',
        // ⭐ Batch 3: Help Text & Hints (2026-07-01)
        'cover_hint' => 'Recommended size: 750x400px, supports jpg/png, max 2MB',
        'cover_preview_alt' => 'Cover Preview',
        'no_vip_data_desc' => 'No VIP level data',
        'set_live_stream_title' => 'Set Live Stream Name',
        'live_stream_hint' => '💡 Just fill in stream name, system will auto-generate Tencent Cloud live URL',
        'live_stream_label' => 'Live Stream Name',
        'live_stream_placeholder' => 'e.g.: mojiangjuan',
        'live_stream_name_hint' => 'Recommend using letters, numbers, underscores. Must match OBS streaming config',
        'live_preview_title' => 'Live Preview - {name}',
        'live_url_label' => 'Live URL:',
        'copy_url' => 'Copy URL',
        'open_new_window' => 'Open in New Window',
        'rtmp_protocol_warning' => 'RTMP Protocol Playback Notice',
        'no_live_url' => 'No live URL available',
        'generating_live_url' => 'Generating live URL...',
        'live_url_copied' => 'Live URL copied to clipboard',
        'stream_name_format_error' => 'Stream name can only contain letters, numbers and underscores',
        'stream_name_too_long' => 'Stream name cannot exceed 50 characters',
        'activity_no_live_url' => 'This activity has not set live stream name yet',
        'generate_live_url_failed' => 'Failed to generate live URL',
        'edit_live_url' => 'Edit Live URL',
        'cancel_enter_win' => 'Cancel, enter winners first',
    ],
];
