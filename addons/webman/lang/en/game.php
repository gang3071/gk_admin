...
return [
    ...
    'fields' => [
        'name' => 'Game name',
        'code' => 'Game ID',
        'platform_id ' => 'Gaming platform ',
        'game_extend_id' => 'Game',
        'cate_id' => 'Game Classification',
        ...
        'portrait_picture' => 'Game portrait picture',
        'enable_portrait_picture' => 'Enable portrait picture',
        'description' => 'Description Information',
        'status' => 'State',
        'sort' => 'Sort ',
        'created at' => 'Creation time',
        'channel_hidden' => 'Choose hidden channels',
        'display_mode' => 'Straight or horizontal',
    ],
    'display_mode' => [
        1 => 'horizontal',
        2 => 'Straight',
    ...
    'help' => [
        ...
        'portrait_picture_size' => 'The game portrait image size cannot exceed 5MB',
    ],
