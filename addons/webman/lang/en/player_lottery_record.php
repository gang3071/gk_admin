...
return [
    ...
    'btn' => [
        ...
        'retry_pokemon_ball' => 'Retry Distribution',
        'retry_pokemon_ball_confirm' => 'Are you sure to retry Pokemon Ball distribution? The system will resend notification to the player.',
    ],
    ...
    'retry_success' => 'Retry distribution successful, notification sent to player',
    ...
    'status' => [
        ...
        PlayerLotteryRecord::STATUS_POKEMON_BALL_FAILED => 'Distribution Failed',
    ],
    'total_data' => [
