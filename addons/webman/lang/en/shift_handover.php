...
return [
    ...
    'auto' => [
        ...
        'total_out_detail' => 'Total Expense (Wash Score)',
    ...
    'no_shift_records' => 'No shift records (Please select shift records before exporting, or check filter criteria)',
    ...
    'device' => [
        ...
        'label' => [
            ...
            'withdrawal_amount' => 'Wash Score Amount:',
