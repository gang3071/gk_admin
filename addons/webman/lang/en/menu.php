...
return [
    ...
    'titles' => [
        ...
        //New Menu Translations (2026-05-13)
        'plugin_manage' => 'Plugin Management',
        'game_list' => 'Game List',
        'machine_label' => 'Machine Label',
        'sms_log' => 'SMS Log',
        'player_report' => 'Player Report',
        'national_promoter_manage' => 'National Promoter Management',
        'user_level_setting' => 'User Level Setting',
        'invite_reward' => 'Invite Reward',
        'bank_list' => 'Bank List',
        'national_promoter_report' => 'National Promoter Report',
        'profit_detail' => 'Profit Detail',
        'reverse_water_manage' => 'Reverse Water Management',
        'reverse_water_activity' => 'Reverse Water Activity',
        'reverse_water_reward_record' => 'Reverse Water Reward Record',
        'tencent_cloud_config' => 'Tencent Cloud Configuration',
        'profit_report' => 'Profit Report',
        'admin_operation' => 'Admin Operation',
        'coin_withdraw_record' => 'Coin Withdraw Record',
        'machine_reward_report' => 'Machine Reward Report',
        'admin_operation_log' => 'Admin Operation Log',
        'profit_settlement' => 'Profit Settlement',
        'profit_manage' => 'Profit Management',
        'offline_agent' => 'Offline Agent',
        'offline_agent_manage' => 'Offline Agent Management',
        'offline_agent_list' => 'Offline Agent List',
        'settlement_record' => 'Settlement Record',
        'game_lottery' => 'Game Lottery',
        'game_player' => 'Game Player',
        'agent_manage' => 'Agent Backend',
