 ...
 * @group channel
 */
class ChannelDepositBonusActivityController
{
    protected $model;
        ...
        return Grid::create(new $this->model(), function (Grid $grid) {
            ...
            $grid->column('activity_name', admin_trans('deposit_bonus_activity.fields.activity_name'))
                ->display(function ($val, DepositBonusActivity $data) {
                    ...
                    ])->drawer(['addons-webman-controller-ChannelDepositBonusActivityController', 'detail'], ['id' => $data->id]);
                })->align('center');
            ...
            $form->saving(function (Form $form) {
                try {
                    ...
                    if (!$form->isEdit()) {
                        ...
                        $activity->store_id = Admin::user()->department_id;
