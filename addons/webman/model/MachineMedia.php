...
class MachineMedia extends Model
{
    ...
    protected static function booted()
    {
        static::updated(function (MachineMedia $machineMedia) {
            ...
            if ($machineMedia->wasChanged($columns) && !empty(Admin::user())) {
                ...
                $machineEditLog->department_id = Admin::user()->department_id ?? 0;
                ...
                $machineEditLog->user_id = Admin::id() ?? 0;
                $machineEditLog->user_name = Admin::user()->username ?? '';
                $machineEditLog->save();
            }
        });
    }
