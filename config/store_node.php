...
return [
    ...
    // 餐點管理
    [
        'id' => 'addons\webman\controller\StoreDishController-',
        'pid' => 0,
        'url' => '',
        'group' => 'store',
        'title' => '餐點管理',
    ...
    [
        'id' => 'addons\webman\controller\StoreDishController\index',
        'pid' => 'addons\webman\controller\StoreDishController-',
        'action' => 'index',
        'method' => 'get',
        'group' => 'store',
        'url' => 'ex-admin/addons-webman-controller-StoreDishController/index',
        'title' => '餐點列表',
    ],
    [
        'id' => 'addons\webman\controller\StoreDishController\form-post',
        'pid' => 'addons\webman\controller\StoreDishController\index',
        'action' => 'form',
        'method' => 'post',
        'group' => 'store',
        'url' => 'ex-admin/addons-webman-controller-StoreDishController/form',
        'title' => '添加配置',
    ],
    [
        'id' => 'addons\webman\controller\StoreDishController\form-put',
        'pid' => 'addons\webman\controller\StoreDishController\index',
        'action' => 'form',
        'method' => 'put',
        'group' => 'store',
    ...
    [
        'id' => 'addons\webman\controller\StoreDishOrderController\index',
        'pid' => 'addons\webman\controller\StoreDishController-',
        'action' => 'index',
        'method' => 'get',
        'group' => 'store',
    ...
    [
        'id' => 'addons\webman\controller\StoreDishOrderController\form-put',
        'pid' => 'addons\webman\controller\StoreDishOrderController\index',
        'action' => 'form',
        'method' => 'put',
        'group' => 'store',
