...
return [
    ...
    // 餐點管理
    [
        'id' => 'addons\webman\controller\DishController-',
        'pid' => 0,
        'url' => '',
        'group' => 'store',
        'title' => '餐點管理',
        'children' => [
            [
                'id' => 'addons\webman\controller\DishController\index',
                'pid' => 'addons\webman\controller\DishController-',
                'action' => 'index',
                'method' => 'get',
                'group' => 'store',
                'url' => 'ex-admin/addons-webman-controller-DishController/index',
                'title' => '餐點列表',
            ],
            [
                'id' => 'addons\webman\controller\DishController\form-post',
                'pid' => 'addons\webman\controller\DishController\index',
                'action' => 'form',
                'method' => 'post',
                'group' => 'store',
                'url' => 'ex-admin/addons-webman-controller-DishController/form',
                'title' => '添加配置',
            ],
            [
                'id' => 'addons\webman\controller\DishController\form-put',
                'pid' => 'addons\webman\controller\DishController\index',
                'action' => 'form',
                'method' => 'put',
                'group' => 'store',
            ...
            [
                'id' => 'addons\webman\controller\DishOrderController\index',
                'pid' => 'addons\webman\controller\DishController-',
                'action' => 'index',
                'method' => 'get',
                'group' => 'store',
                'url' => 'ex-admin/addons-webman-controller-DishOrderController/index',
                'title' => '餐點訂單',
            ],
            [
